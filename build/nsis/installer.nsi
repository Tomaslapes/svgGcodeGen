!define PRODUCT_NAME "gCodeGenerator"
!define PRODUCT_VERSION "1.0"
!define PY_VERSION "3.6.3"
!define PY_MAJOR_VERSION "3.6"
!define BITNESS "32"
!define ARCH_TAG ""
!define INSTALLER_NAME "gCodeGenerator_1.0.exe"
!define PRODUCT_ICON "3D_software_24132.ico"
...
!define MULTIUSER_INSTALLMODE_INSTDIR "gCodeGenerator"
...
!define MUI_ICON "3D_software_24132.ico"
!define MUI_UNICON "3D_software_24132.ico"
...
Section "!${PRODUCT_NAME}" sec_app
  ...
  StrCmp $MultiUser.InstallMode CurrentUser 0 +3
    ...
    SetFileAttributes "$INSTDIR\${USER_INSTALL_MARKER}" HIDDEN
      ...
      ; Install files
    SetOutPath "$INSTDIR"
      File "gCodeGenerator.launch.pyw"
      File "3D_software_24132.ico"
  ...
  SetOutPath "%HOMEDRIVE%\%HOMEPATH%"
    CreateShortCut "$SMPROGRAMS\gCodeGenerator.lnk" "$INSTDIR\Python\pythonw.exe" \
      '"$INSTDIR\gCodeGenerator.launch.pyw"' "$INSTDIR\3D_software_24132.ico"
  SetOutPath "$INSTDIR"
...
Section "Uninstall"
  ...
  ; Uninstall files
    Delete "$INSTDIR\gCodeGenerator.launch.pyw"
    Delete "$INSTDIR\3D_software_24132.ico"
  ; Uninstall directories
    RMDir /r "$INSTDIR\Python"

  ; Uninstall shortcuts
      Delete "$SMPROGRAMS\gCodeGenerator.lnk"
  RMDir $INSTDIR
